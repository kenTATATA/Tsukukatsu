...
export default function SignupPage() {
  ...
  const graduationYearOptions = Array.from({ length: 6 }, (_, i) => currentYear + i); // 今年から6年後までの年度を生成
    ...
    <div>
      ...
      <div className={styles.signupContainer}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <button type="submit" className={styles.button} disabled={!isFormValid()}>登録する</button>
        </form>
      </div>
    </div>
  );
